...
${THRIFT_COMPILER} -o ${DIR} --gen js:node ${THRIFT_FILES_DIR}/lib/js/test/JsDeepConstructorTest.thrift
...
${THRIFT_COMPILER} -out ${DIR}/gen-nodejs-es6 --gen js:node,es6 ${THRIFT_FILES_DIR}/js/lib/test/JsDeepConstructorTest.thrift
