...
class TSocket extends TTransport
{
     ...
     * timeout. Defaults to 0 seconds.
     */
    protected int $connectTimeoutSec = 0;

    /**
     * Connect timeout in microseconds.
     *
     * Combined with connectTimeoutSec this is used for the fsockopen()
     * timeout. Defaults to 100000 microseconds (0.1s).
     */
    protected int $connectTimeoutUsec = 100000;
     ...
     *        output. Defaults to NullLogger (silent).
     */
    public function __construct(
        ...
        $this->logger = $debugHandler ?? new NullLogger();
    }
