...
class TJSONProtocolTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        if (!is_dir(__DIR__ . '/../../../Resources/packages/php')) {
            self::fail(
                'Before running Integratin test suite, you must run the Thrift compiler against the ThriftTest.thrift file in the ./Resources directory.'
            );
        }
    ...
    public function writeDataProvider()
    {
        ...
        yield 'void' => [
            'argsClassName' => \ThriftTest\ThriftTest_testVoid_args::class,
            'argsValues' => [],
            'expected' => '{}',
        ];
        yield 'bool true' => [
            'argsClassName' => \ThriftTest\ThriftTest_testBool_args::class,
            'argsValues' => [
                'thing' => true,
            ],
            'expected' => '{"1":{"tf":1}}',
        ...
        yield 'string1' => [
            'argsClassName' => \ThriftTest\ThriftTest_testString_args::class,
            'argsValues' => [
        ...
        yield 'double' => [
            'argsClassName' => \ThriftTest\ThriftTest_testDouble_args::class,
            'argsValues' => [
        ...
        yield 'byte' => [
            'argsClassName' => \ThriftTest\ThriftTest_testByte_args::class,
            'argsValues' => [
                'thing' => 0x01,
            ],
            'expected' => '{"1":{"i8":1}}',
        ...
        yield 'i32' => [
            'argsClassName' => \ThriftTest\ThriftTest_testI32_args::class,
            'argsValues' => [
                'thing' => pow(2, 30),
            ],
        ...
        if (PHP_INT_SIZE == 8) {
            yield 'i64_64Architecture' => [
                'argsClassName' => \ThriftTest\ThriftTest_testI64_args::class,
                'argsValues' => [
                    'thing' => pow(2, 60),
                ],
            ...
            yield 'struct_64Architecture' => [
                'argsClassName' => \ThriftTest\ThriftTest_testStruct_args::class,
                'argsValues' => [
                    'thing' => new Xtruct(
                        [
                            'string_thing' => 'worked',
            ...
            yield 'nest_64Architecture' => [
                'argsClassName' => \ThriftTest\ThriftTest_testNest_args::class,
                'argsValues' => [
                    'thing' => new Xtruct2(
                        [
                            'byte_thing' => 0x01,
        ...
        yield 'map' => [
            'argsClassName' => \ThriftTest\ThriftTest_testMap_args::class,
            'argsValues' => [
                'thing' => [
                    7 => 77,
                    8 => 88,
        ...
        yield 'stringMap' => [
            'argsClassName' => \ThriftTest\ThriftTest_testStringMap_args::class,
            'argsValues' => [
                'thing' => [
                    "a" => "123",
                    "a b" => "with spaces ",
        ...
        yield 'set' => [
            'argsClassName' => \ThriftTest\ThriftTest_testSet_args::class,
            'argsValues' => [
        ...
        yield 'list' => [
            'argsClassName' => \ThriftTest\ThriftTest_testList_args::class,
            'argsValues' => [
                'thing' => [1, 2, 3],
            ],
        ...
        yield 'enum' => [
            'argsClassName' => \ThriftTest\ThriftTest_testEnum_args::class,
            'argsValues' => [
                'thing' => \ThriftTest\Numberz::SIX,
            ],
            'expected' => '{"1":{"i32":6}}',
        ];
        yield 'typedef' => [
            'argsClassName' => \ThriftTest\ThriftTest_testTypedef_args::class,
            'argsValues' => [
                'thing' => 69,
            ],
            'expected' => '{"1":{"i64":69}}',
    ...
    public function readDataProvider()
    {
        ...
        yield 'mapmap' => [
            ...
            'argsClassName' => \ThriftTest\ThriftTest_testMapMap_result::class,
        ...
        yield 'insanity' => [
            ...
            'argsClassName' => \ThriftTest\ThriftTest_testInsanity_result::class,
            'argsPropertyName' => 'success',
            'expectedValue' => [
                "1" => [
