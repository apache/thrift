...
export function ThriftTestDriver(client: ThriftTest.ThriftTest.Client, callback: (status: string) => void) {
  ...
  test("NodeJS Style Callback Client Tests", function(assert) {
    ...
    client.testException("TException", function(err) {
      assert.ok(err instanceof TException, "testException: correct error type");
    });

    client.testException("Xception", function(err) {
      assert.ok(err instanceof ttypes.ThriftTest.Xception, "testException: correct error type");
    ...
    client.testException("no Exception", function(err) {
      assert.error(err, "testException: no callback error");
    });

    client.testOneway(0, function(err) {
...
export function ThriftTestDriverPromise(client: ThriftTest.ThriftTest.Client, callback: (status: string) => void) {
  ...
  test("Q Promise Client Tests", function(assert) {
    ...
    Q.resolve(client.testException("Xception"))
      ...
      .fail(function(err) {
        assert.ok(err instanceof ttypes.ThriftTest.Xception);
