...
export var simple = [
  ...
  ['testEnum', ttypes.ThriftTest.Numberz.ONE]
];
...
export var out = new ttypes.ThriftTest.Xtruct({
  string_thing: 'Zero',
  byte_thing: 1,
  i32_thing: -3,
  i64_thing: 1000000
...
export var out2 = new ttypes.ThriftTest.Xtruct2();
out2.byte_thing = 1;
out2.struct_thing = out;
out2.i32_thing = 5;

export var crazy = new ttypes.ThriftTest.Insanity({
  "userMap":{ "5":5, "8":8 },
  "xtructs":[new ttypes.ThriftTest.Xtruct({
      "string_thing":"Goodbye4",
      "byte_thing":4,
      "i32_thing":4,
      "i64_thing":4
    }), new ttypes.ThriftTest.Xtruct({
      "string_thing":"Hello2",
      "byte_thing":2,
      "i32_thing":2,
      "i64_thing":2
