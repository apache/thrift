...
struct_info_test_() ->
    [
        ...
        {"delegate extended definition",
            ?_assertEqual(
                {struct, struct, [
                    ...
                    {2, undefined, {struct, struct, {name_conflict_test_thrift, delegate}},
                        delegate, undefined}
                ]},
        ...
        {"partial extended definition",
            ?_assertEqual(
                {struct, struct, [
                    {1, undefined, {struct, struct, {name_conflict_test_thrift, using}}, using,
                        undefined},
...
service_info_test_() ->
    [
        {"event params",
            ?_assertEqual(
                {struct, struct, [
                    {1, undefined, {struct, struct, {name_conflict_test_thrift, partial}}, 'get',
                        undefined}
                ]},
        ...
        {"Foo params",
            ?_assertEqual(
                {struct, struct, [
                    {1, undefined, {struct, struct, {name_conflict_test_thrift, 'Nested'}},
                        'Foo_args', undefined}
                ]},
        ...
        {"Foo exceptions",
            ?_assertEqual(
                {struct, struct, [
                    {1, undefined, {struct, exception, {name_conflict_test_thrift, 'Problem_'}},
                        'Foo_result', undefined}
                ]},
