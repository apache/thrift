...
struct_info_test_() ->
    [
        ...
        {"Xtruct2 definition",
            ?_assertEqual(
                {struct, struct, [
                    ...
                    {2, undefined, {struct, struct, {'thrift_test_thrift', 'Xtruct'}}, struct_thing,
                        undefined},
        ...
        {"Insanity definition",
            ?_assertEqual(
                {struct, struct, [
                    {1, undefined, {map, {enum, {'thrift_test_thrift', 'Numberz'}}, i64}, userMap,
                        undefined},
                    {2, undefined, {list, {struct, struct, {'thrift_test_thrift', 'Xtruct'}}},
                        xtructs, undefined}
                ]},
        ...
        {"CrazyNesting definition",
            ?_assertEqual(
                {struct, struct, [
                    ...
                    {2, optional, {set, {struct, struct, {'thrift_test_thrift', 'Insanity'}}},
                        set_field, undefined},
                    {3, required,
                        {list,
                            {map, {set, i32},
        ...
        {"OneField definition",
            ?_assertEqual(
                {struct, struct, [
                    {1, undefined, {struct, struct, {'thrift_test_thrift', 'EmptyStruct'}}, field,
                        undefined}
                ]},
        ...
        {"VersioningTestV2 definition",
            ?_assertEqual(
                {struct, struct, [
                    ...
                    {7, undefined, {struct, struct, {thrift_test_thrift, 'Bonk'}}, newstruct,
                        undefined},
        ...
        {"LargeDeltas definition",
            ?_assertEqual(
                {struct, struct, [
                    ...
                    {10, undefined, {struct, struct, {thrift_test_thrift, 'Bools'}}, b10,
                        undefined},
                    {100, undefined, {struct, struct, {thrift_test_thrift, 'Bools'}}, b100,
                        undefined},
                    {500, undefined, bool, check_true, undefined},
                    {1000, undefined, {struct, struct, {thrift_test_thrift, 'Bools'}}, b1000,
                        undefined},
                    {1500, undefined, bool, check_false, undefined},
                    {2000, undefined, {struct, struct, {thrift_test_thrift, 'VersioningTestV2'}},
                        vertwo2000, undefined},
                    {2500, undefined, {set, string}, a_set2500, undefined},
                    {3000, undefined, {struct, struct, {thrift_test_thrift, 'VersioningTestV2'}},
                        vertwo3000, undefined},
        ...
        {"ListBonks definition",
            ?_assertEqual(
                {struct, struct, [
                    {1, undefined, {list, {struct, struct, {thrift_test_thrift, 'Bonk'}}}, bonk,
                        undefined}
                ]},
        ...
        {"NestedListsBonk definition",
            ?_assertEqual(
                {struct, struct, [
                    {1, undefined,
                        {list, {list, {list, {struct, struct, {thrift_test_thrift, 'Bonk'}}}}},
                        bonk, undefined}
                ]},
...
service_info_test_() ->
    [
        ...
        {"testStruct params",
            ?_assertEqual(
                {struct, struct, [
                    {1, undefined, {struct, struct, {thrift_test_thrift, 'Xtruct'}}, 'thing',
                        undefined}
                ]},
        ...
        {"testNest params",
            ?_assertEqual(
                {struct, struct, [
                    {1, undefined, {struct, struct, {thrift_test_thrift, 'Xtruct2'}}, 'thing',
                        undefined}
                ]},
        ...
        {"testInsanity params",
            ?_assertEqual(
                {struct, struct, [
                    {1, undefined, {struct, struct, {thrift_test_thrift, 'Insanity'}}, 'argument',
                        undefined}
                ]},
        ...
        {"testInsanity reply",
            ?_assertEqual(
                {map, i64,
                    {map, {enum, {thrift_test_thrift, 'Numberz'}},
        ...
        {"testException exceptions",
            ?_assertEqual(
                {struct, struct, [
                    {1, undefined, {struct, exception, {thrift_test_thrift, 'Xception'}}, 'err1',
                        undefined}
                ]},
        ...
        {"testMultiException exceptions",
            ?_assertEqual(
                {struct, struct, [
                    {1, undefined, {struct, exception, {thrift_test_thrift, 'Xception'}}, 'err1',
                        undefined},
                    {2, undefined, {struct, exception, {thrift_test_thrift, 'Xception2'}}, 'err2',
                        undefined}
                ]},
