...
var guid : TGuid;
const
  WINDOWS_HOST_ORDER : TGuid = '{67452301-ab89-efcd-0123-456789abcdef}';
  NETWORK_BYTE_ORDER : TGuid = '{01234567-89ab-cdef-0123-456789abcdef}';
begin
  guid := WINDOWS_HOST_ORDER;
  guid := guid.SwapByteOrder;
  ASSERT( IsEqualGuid( guid, NETWORK_BYTE_ORDER));
  guid := guid.SwapByteOrder;
  ASSERT( IsEqualGuid( guid, WINDOWS_HOST_ORDER));
end;
{$ENDIF}
