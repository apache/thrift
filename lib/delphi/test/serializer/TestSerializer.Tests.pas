...
begin
  ...
  serial := TSerializer.Create( factory.prot, factory.trans, config.GetConfiguration);
  try
...
begin
  ...
  serial := TDeserializer.Create( factory.prot, factory.trans, config.GetConfiguration);
  try
