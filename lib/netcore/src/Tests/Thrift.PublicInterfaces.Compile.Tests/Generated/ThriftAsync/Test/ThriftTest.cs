...
namespace ThriftAsync.Test
{
    public partial class ThriftTest
    {
        ...
        public interface IAsync
        {
            ...
            [OperationContract]
            Task<Xtruct> testMultiAsync(sbyte arg0, int arg1, long arg2, Dictionary<short, string> arg3, Numberz arg4,
                long arg5, CancellationToken cancellationToken);
            ...
            ///     elsen if arg0 == "Xception2" throw Xception2 with errorCode = 2002 and struct_thing.string_thing = "This is an
            ///     Xception2"
            ///     else do not throw anything
        ...
        public class Client : TBaseClient, IDisposable, IAsync
        {
            ...
            {
                await
                    OutputProtocol.WriteMessageBeginAsync(new TMessage("testVoid", TMessageType.Call, SeqId),
                        cancellationToken);
            ...
            {
                await
                    OutputProtocol.WriteMessageBeginAsync(new TMessage("testString", TMessageType.Call, SeqId),
                        cancellationToken);
            ...
            {
                await
                    OutputProtocol.WriteMessageBeginAsync(new TMessage("testBool", TMessageType.Call, SeqId),
                        cancellationToken);
            ...
            {
                await
                    OutputProtocol.WriteMessageBeginAsync(new TMessage("testByte", TMessageType.Call, SeqId),
                        cancellationToken);
            ...
            {
                await
                    OutputProtocol.WriteMessageBeginAsync(new TMessage("testI32", TMessageType.Call, SeqId),
                        cancellationToken);
            ...
            {
                await
                    OutputProtocol.WriteMessageBeginAsync(new TMessage("testI64", TMessageType.Call, SeqId),
                        cancellationToken);
            ...
            {
                await
                    OutputProtocol.WriteMessageBeginAsync(new TMessage("testDouble", TMessageType.Call, SeqId),
                        cancellationToken);
            ...
            {
                await
                    OutputProtocol.WriteMessageBeginAsync(new TMessage("testBinary", TMessageType.Call, SeqId),
                        cancellationToken);
            ...
            {
                await
                    OutputProtocol.WriteMessageBeginAsync(new TMessage("testStruct", TMessageType.Call, SeqId),
                        cancellationToken);
            ...
            {
                await
                    OutputProtocol.WriteMessageBeginAsync(new TMessage("testNest", TMessageType.Call, SeqId),
                        cancellationToken);
            ...
            {
                await
                    OutputProtocol.WriteMessageBeginAsync(new TMessage("testMap", TMessageType.Call, SeqId),
                        cancellationToken);
            ...
            {
                await
                    OutputProtocol.WriteMessageBeginAsync(new TMessage("testStringMap", TMessageType.Call, SeqId),
                        cancellationToken);
            ...
            {
                await
                    OutputProtocol.WriteMessageBeginAsync(new TMessage("testSet", TMessageType.Call, SeqId),
                        cancellationToken);
            ...
            {
                await
                    OutputProtocol.WriteMessageBeginAsync(new TMessage("testList", TMessageType.Call, SeqId),
                        cancellationToken);
            ...
            {
                await
                    OutputProtocol.WriteMessageBeginAsync(new TMessage("testEnum", TMessageType.Call, SeqId),
                        cancellationToken);
            ...
            {
                await
                    OutputProtocol.WriteMessageBeginAsync(new TMessage("testTypedef", TMessageType.Call, SeqId),
                        cancellationToken);
            ...
            {
                await
                    OutputProtocol.WriteMessageBeginAsync(new TMessage("testMapMap", TMessageType.Call, SeqId),
                        cancellationToken);
            ...
            {
                await
                    OutputProtocol.WriteMessageBeginAsync(new TMessage("testInsanity", TMessageType.Call, SeqId),
                        cancellationToken);
            ...
            public async Task<Xtruct> testMultiAsync(sbyte arg0, int arg1, long arg2, Dictionary<short, string> arg3,
                Numberz arg4, long arg5, CancellationToken cancellationToken)
            {
                await
                    OutputProtocol.WriteMessageBeginAsync(new TMessage("testMulti", TMessageType.Call, SeqId),
                        cancellationToken);
            ...
            {
                await
                    OutputProtocol.WriteMessageBeginAsync(new TMessage("testException", TMessageType.Call, SeqId),
                        cancellationToken);
            ...
            {
                await
                    OutputProtocol.WriteMessageBeginAsync(new TMessage("testMultiException", TMessageType.Call, SeqId),
                        cancellationToken);
            ...
            {
                await
                    OutputProtocol.WriteMessageBeginAsync(new TMessage("testOneway", TMessageType.Oneway, SeqId),
                        cancellationToken);
        ...
        public class AsyncProcessor : ITAsyncProcessor
        {
                ...
                CancellationToken cancellationToken)
            {
                ...
                try
                {
                    ...
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testVoid", TMessageType.Reply, seqid),
                            cancellationToken);
                ...
                catch (Exception ex)
                {
                    ...
                    var x = new TApplicationException(TApplicationException.ExceptionType.InternalError,
                        " Internal error.");
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testVoid", TMessageType.Exception, seqid),
                            cancellationToken);
                    await x.WriteAsync(oprot, cancellationToken);
                }
                await oprot.WriteMessageEndAsync(cancellationToken);
                ...
                CancellationToken cancellationToken)
            {
                ...
                try
                {
                    ...
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testString", TMessageType.Reply, seqid),
                            cancellationToken);
                    await result.WriteAsync(oprot, cancellationToken);
                }
                catch (TTransportException)
                ...
                catch (Exception ex)
                {
                    ...
                    var x = new TApplicationException(TApplicationException.ExceptionType.InternalError,
                        " Internal error.");
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testString", TMessageType.Exception, seqid),
                            cancellationToken);
                    await x.WriteAsync(oprot, cancellationToken);
                }
                await oprot.WriteMessageEndAsync(cancellationToken);
                ...
                CancellationToken cancellationToken)
            {
                ...
                try
                {
                    ...
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testBool", TMessageType.Reply, seqid),
                            cancellationToken);
                    await result.WriteAsync(oprot, cancellationToken);
                }
                catch (TTransportException)
                ...
                catch (Exception ex)
                {
                    ...
                    var x = new TApplicationException(TApplicationException.ExceptionType.InternalError,
                        " Internal error.");
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testBool", TMessageType.Exception, seqid),
                            cancellationToken);
                    await x.WriteAsync(oprot, cancellationToken);
                }
                await oprot.WriteMessageEndAsync(cancellationToken);
                ...
                CancellationToken cancellationToken)
            {
                ...
                try
                {
                    ...
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testByte", TMessageType.Reply, seqid),
                            cancellationToken);
                    await result.WriteAsync(oprot, cancellationToken);
                }
                catch (TTransportException)
                ...
                catch (Exception ex)
                {
                    ...
                    var x = new TApplicationException(TApplicationException.ExceptionType.InternalError,
                        " Internal error.");
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testByte", TMessageType.Exception, seqid),
                            cancellationToken);
                    await x.WriteAsync(oprot, cancellationToken);
                }
                await oprot.WriteMessageEndAsync(cancellationToken);
                ...
                CancellationToken cancellationToken)
            {
                ...
                try
                {
                    ...
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testI32", TMessageType.Reply, seqid),
                            cancellationToken);
                    await result.WriteAsync(oprot, cancellationToken);
                }
                catch (TTransportException)
                ...
                catch (Exception ex)
                {
                    ...
                    var x = new TApplicationException(TApplicationException.ExceptionType.InternalError,
                        " Internal error.");
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testI32", TMessageType.Exception, seqid),
                            cancellationToken);
                    await x.WriteAsync(oprot, cancellationToken);
                }
                await oprot.WriteMessageEndAsync(cancellationToken);
                ...
                CancellationToken cancellationToken)
            {
                ...
                try
                {
                    ...
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testI64", TMessageType.Reply, seqid),
                            cancellationToken);
                    await result.WriteAsync(oprot, cancellationToken);
                }
                catch (TTransportException)
                ...
                catch (Exception ex)
                {
                    ...
                    var x = new TApplicationException(TApplicationException.ExceptionType.InternalError,
                        " Internal error.");
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testI64", TMessageType.Exception, seqid),
                            cancellationToken);
                    await x.WriteAsync(oprot, cancellationToken);
                }
                await oprot.WriteMessageEndAsync(cancellationToken);
                ...
                CancellationToken cancellationToken)
            {
                ...
                try
                {
                    ...
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testDouble", TMessageType.Reply, seqid),
                            cancellationToken);
                    await result.WriteAsync(oprot, cancellationToken);
                }
                catch (TTransportException)
                ...
                catch (Exception ex)
                {
                    ...
                    var x = new TApplicationException(TApplicationException.ExceptionType.InternalError,
                        " Internal error.");
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testDouble", TMessageType.Exception, seqid),
                            cancellationToken);
                    await x.WriteAsync(oprot, cancellationToken);
                }
                await oprot.WriteMessageEndAsync(cancellationToken);
                ...
                CancellationToken cancellationToken)
            {
                ...
                try
                {
                    ...
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testBinary", TMessageType.Reply, seqid),
                            cancellationToken);
                    await result.WriteAsync(oprot, cancellationToken);
                }
                catch (TTransportException)
                ...
                catch (Exception ex)
                {
                    ...
                    var x = new TApplicationException(TApplicationException.ExceptionType.InternalError,
                        " Internal error.");
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testBinary", TMessageType.Exception, seqid),
                            cancellationToken);
                    await x.WriteAsync(oprot, cancellationToken);
                }
                await oprot.WriteMessageEndAsync(cancellationToken);
                ...
                CancellationToken cancellationToken)
            {
                ...
                try
                {
                    ...
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testStruct", TMessageType.Reply, seqid),
                            cancellationToken);
                    await result.WriteAsync(oprot, cancellationToken);
                }
                catch (TTransportException)
                ...
                catch (Exception ex)
                {
                    ...
                    var x = new TApplicationException(TApplicationException.ExceptionType.InternalError,
                        " Internal error.");
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testStruct", TMessageType.Exception, seqid),
                            cancellationToken);
                    await x.WriteAsync(oprot, cancellationToken);
                }
                await oprot.WriteMessageEndAsync(cancellationToken);
                ...
                CancellationToken cancellationToken)
            {
                ...
                try
                {
                    ...
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testNest", TMessageType.Reply, seqid),
                            cancellationToken);
                    await result.WriteAsync(oprot, cancellationToken);
                }
                catch (TTransportException)
                ...
                catch (Exception ex)
                {
                    ...
                    var x = new TApplicationException(TApplicationException.ExceptionType.InternalError,
                        " Internal error.");
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testNest", TMessageType.Exception, seqid),
                            cancellationToken);
                    await x.WriteAsync(oprot, cancellationToken);
                }
                await oprot.WriteMessageEndAsync(cancellationToken);
                ...
                CancellationToken cancellationToken)
            {
                ...
                try
                {
                    ...
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testMap", TMessageType.Reply, seqid),
                            cancellationToken);
                    await result.WriteAsync(oprot, cancellationToken);
                }
                catch (TTransportException)
                ...
                catch (Exception ex)
                {
                    ...
                    var x = new TApplicationException(TApplicationException.ExceptionType.InternalError,
                        " Internal error.");
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testMap", TMessageType.Exception, seqid),
                            cancellationToken);
                    await x.WriteAsync(oprot, cancellationToken);
                }
                await oprot.WriteMessageEndAsync(cancellationToken);
                ...
                CancellationToken cancellationToken)
            {
                ...
                try
                {
                    ...
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testStringMap", TMessageType.Reply, seqid),
                            cancellationToken);
                    await result.WriteAsync(oprot, cancellationToken);
                }
                catch (TTransportException)
                ...
                catch (Exception ex)
                {
                    ...
                    var x = new TApplicationException(TApplicationException.ExceptionType.InternalError,
                        " Internal error.");
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testStringMap", TMessageType.Exception, seqid),
                            cancellationToken);
                    await x.WriteAsync(oprot, cancellationToken);
                }
                await oprot.WriteMessageEndAsync(cancellationToken);
                ...
                CancellationToken cancellationToken)
            {
                ...
                try
                {
                    ...
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testSet", TMessageType.Reply, seqid),
                            cancellationToken);
                    await result.WriteAsync(oprot, cancellationToken);
                }
                catch (TTransportException)
                ...
                catch (Exception ex)
                {
                    ...
                    var x = new TApplicationException(TApplicationException.ExceptionType.InternalError,
                        " Internal error.");
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testSet", TMessageType.Exception, seqid),
                            cancellationToken);
                    await x.WriteAsync(oprot, cancellationToken);
                }
                await oprot.WriteMessageEndAsync(cancellationToken);
                ...
                CancellationToken cancellationToken)
            {
                ...
                try
                {
                    ...
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testList", TMessageType.Reply, seqid),
                            cancellationToken);
                    await result.WriteAsync(oprot, cancellationToken);
                }
                catch (TTransportException)
                ...
                catch (Exception ex)
                {
                    ...
                    var x = new TApplicationException(TApplicationException.ExceptionType.InternalError,
                        " Internal error.");
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testList", TMessageType.Exception, seqid),
                            cancellationToken);
                    await x.WriteAsync(oprot, cancellationToken);
                }
                await oprot.WriteMessageEndAsync(cancellationToken);
                ...
                CancellationToken cancellationToken)
            {
                ...
                try
                {
                    ...
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testEnum", TMessageType.Reply, seqid),
                            cancellationToken);
                    await result.WriteAsync(oprot, cancellationToken);
                }
                catch (TTransportException)
                ...
                catch (Exception ex)
                {
                    ...
                    var x = new TApplicationException(TApplicationException.ExceptionType.InternalError,
                        " Internal error.");
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testEnum", TMessageType.Exception, seqid),
                            cancellationToken);
                    await x.WriteAsync(oprot, cancellationToken);
                }
                await oprot.WriteMessageEndAsync(cancellationToken);
                ...
                CancellationToken cancellationToken)
            {
                ...
                try
                {
                    ...
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testTypedef", TMessageType.Reply, seqid),
                            cancellationToken);
                    await result.WriteAsync(oprot, cancellationToken);
                }
                catch (TTransportException)
                ...
                catch (Exception ex)
                {
                    ...
                    var x = new TApplicationException(TApplicationException.ExceptionType.InternalError,
                        " Internal error.");
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testTypedef", TMessageType.Exception, seqid),
                            cancellationToken);
                    await x.WriteAsync(oprot, cancellationToken);
                }
                await oprot.WriteMessageEndAsync(cancellationToken);
                ...
                CancellationToken cancellationToken)
            {
                ...
                try
                {
                    ...
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testMapMap", TMessageType.Reply, seqid),
                            cancellationToken);
                    await result.WriteAsync(oprot, cancellationToken);
                }
                catch (TTransportException)
                ...
                catch (Exception ex)
                {
                    ...
                    var x = new TApplicationException(TApplicationException.ExceptionType.InternalError,
                        " Internal error.");
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testMapMap", TMessageType.Exception, seqid),
                            cancellationToken);
                    await x.WriteAsync(oprot, cancellationToken);
                }
                await oprot.WriteMessageEndAsync(cancellationToken);
                ...
                CancellationToken cancellationToken)
            {
                ...
                try
                {
                    ...
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testInsanity", TMessageType.Reply, seqid),
                            cancellationToken);
                    await result.WriteAsync(oprot, cancellationToken);
                }
                catch (TTransportException)
                ...
                catch (Exception ex)
                {
                    ...
                    var x = new TApplicationException(TApplicationException.ExceptionType.InternalError,
                        " Internal error.");
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testInsanity", TMessageType.Exception, seqid),
                            cancellationToken);
                    await x.WriteAsync(oprot, cancellationToken);
                }
                await oprot.WriteMessageEndAsync(cancellationToken);
                ...
                CancellationToken cancellationToken)
            {
                ...
                try
                {
                    result.Success =
                        await
                            _iAsync.testMultiAsync(args.Arg0, args.Arg1, args.Arg2, args.Arg3, args.Arg4, args.Arg5,
                                cancellationToken);
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testMulti", TMessageType.Reply, seqid),
                            cancellationToken);
                    await result.WriteAsync(oprot, cancellationToken);
                }
                catch (TTransportException)
                ...
                catch (Exception ex)
                {
                    ...
                    var x = new TApplicationException(TApplicationException.ExceptionType.InternalError,
                        " Internal error.");
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testMulti", TMessageType.Exception, seqid),
                            cancellationToken);
                    await x.WriteAsync(oprot, cancellationToken);
                }
                await oprot.WriteMessageEndAsync(cancellationToken);
                ...
                CancellationToken cancellationToken)
            {
                ...
                try
                {
                    ...
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testException", TMessageType.Reply, seqid),
                            cancellationToken);
                    await result.WriteAsync(oprot, cancellationToken);
                }
                catch (TTransportException)
                ...
                catch (Exception ex)
                {
                    ...
                    var x = new TApplicationException(TApplicationException.ExceptionType.InternalError,
                        " Internal error.");
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testException", TMessageType.Exception, seqid),
                            cancellationToken);
                    await x.WriteAsync(oprot, cancellationToken);
                }
                await oprot.WriteMessageEndAsync(cancellationToken);
                ...
                CancellationToken cancellationToken)
            {
                ...
                try
                {
                    ...
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testMultiException", TMessageType.Reply, seqid),
                            cancellationToken);
                    await result.WriteAsync(oprot, cancellationToken);
                }
                catch (TTransportException)
                ...
                catch (Exception ex)
                {
                    ...
                    var x = new TApplicationException(TApplicationException.ExceptionType.InternalError,
                        " Internal error.");
                    await
                        oprot.WriteMessageBeginAsync(new TMessage("testMultiException", TMessageType.Exception, seqid),
                            cancellationToken);
                    await x.WriteAsync(oprot, cancellationToken);
                }
                await oprot.WriteMessageEndAsync(cancellationToken);
            ...
            public async Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
            {
                ...
                try
                {
                    ...
                    if (Thing != null && __isset.thing)
                    {
                        ...
                        {
                            await
                                oprot.WriteMapBeginAsync(new TMap(TType.I32, TType.I32, Thing.Count), cancellationToken);
                ...
                try
                {
                    ...
                    if (this.__isset.success)
                    {
                        if (Success != null)
                        {
                            ...
                            {
                                await
                                    oprot.WriteMapBeginAsync(new TMap(TType.I32, TType.I32, Success.Count),
                                        cancellationToken);
            ...
            public async Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
            {
                ...
                try
                {
                    ...
                    if (Thing != null && __isset.thing)
                    {
                        ...
                        {
                            await
                                oprot.WriteMapBeginAsync(new TMap(TType.String, TType.String, Thing.Count),
                                    cancellationToken);
                ...
                try
                {
                    ...
                    if (this.__isset.success)
                    {
                        if (Success != null)
                        {
                            ...
                            {
                                await
                                    oprot.WriteMapBeginAsync(new TMap(TType.I32, TType.Map, Success.Count),
                                        cancellationToken);
                                    ...
                                    await oprot.WriteI32Async(_iter188, cancellationToken);
                                    {
                                        await
                                            oprot.WriteMapBeginAsync(
                                                new TMap(TType.I32, TType.I32, Success[_iter188].Count),
                                                cancellationToken);
        ...
        public partial class testInsanityArgs : TBase
        {
            ...
            public struct Isset
            {
                [DataMember] public bool argument;
            }
        }
                ...
                try
                {
                    ...
                    if (this.__isset.success)
                    {
                        if (Success != null)
                        {
                            ...
                            {
                                await
                                    oprot.WriteMapBeginAsync(new TMap(TType.I64, TType.Map, Success.Count),
                                        cancellationToken);
                                foreach (long _iter198 in Success.Keys)
                                {
                                    await oprot.WriteI64Async(_iter198, cancellationToken);
                                    {
                                        await
                                            oprot.WriteMapBeginAsync(
                                                new TMap(TType.I32, TType.Struct, Success[_iter198].Count),
                                                cancellationToken);
        ...
        public partial class testMultiArgs : TBase
        {
            ...
            public async Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
            {
                ...
                try
                {
                    ...
                    if (Arg3 != null && __isset.arg3)
                    {
                        ...
                        {
                            await
                                oprot.WriteMapBeginAsync(new TMap(TType.I16, TType.String, Arg3.Count),
                                    cancellationToken);
            ...
            public struct Isset
            {
                [DataMember] public bool arg0;
                [DataMember] public bool arg1;
                [DataMember] public bool arg2;
                [DataMember] public bool arg3;
                [DataMember] public bool arg4;
                [DataMember] public bool arg5;
            }
        ...
        public partial class testOnewayArgs : TBase
        {
            ...
            public struct Isset
            {
                [DataMember] public bool secondsToSleep;
            }
        }
    }
}