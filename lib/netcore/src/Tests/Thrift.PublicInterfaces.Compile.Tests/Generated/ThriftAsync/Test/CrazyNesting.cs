...
namespace ThriftAsync.Test
{
    ...
    public partial class CrazyNesting : TBase
    {
        ...
        public CrazyNesting(
            List<Dictionary<THashSet<int>, Dictionary<int, THashSet<List<Dictionary<Insanity, string>>>>>> list_field)
            : this()
        {
        ...
        [DataMember(Order = 0)]
        public List<Dictionary<THashSet<int>, Dictionary<int, THashSet<List<Dictionary<Insanity, string>>>>>> List_field
        { get; set; }

        [DataMember(Order = 0)]
        public byte[] Binary_field
        {
            get { return _binary_field; }
            set
            {
                            ...
                            {
                                {
                                    List_field =
                                        ...
                                        <
                                            Dictionary
                                            <THashSet<int>,
                                                Dictionary<int, THashSet<List<Dictionary<Insanity, string>>>>>>();
                                    TList _list12 = await iprot.ReadListBeginAsync(cancellationToken);
                                    for (int _i13 = 0; _i13 < _list12.Count; ++_i13)
                                    {
                                        Dictionary
                                        <THashSet<int>,
                                            Dictionary<int, THashSet<List<Dictionary<Insanity, string>>>>> _elem14;
                                        {
                                            _elem14 =
                                                new Dictionary
                                                <THashSet<int>,
                                            ...
                                            for (int _i16 = 0; _i16 < _map15.Count; ++_i16)
                                            {
                                                ...
                                                }
                                                {
                                                    _val18 =
                                                        new Dictionary
                                                            <int, THashSet<List<Dictionary<Insanity, string>>>>();
                                                    ...
                                                    for (int _i23 = 0; _i23 < _map22.Count; ++_i23)
                                                    {
                                                        ...
                                                        _key24 = await iprot.ReadI32Async(cancellationToken);
                                                        {
                                                            ...
                                                            TSet _set26 =
                                                                await iprot.ReadSetBeginAsync(cancellationToken);
                                                                    ...
                                                                    for (int _i30 = 0; _i30 < _list29.Count; ++_i30)
                                                                    {
                                                                        Dictionary<Insanity, string> _elem31;
                                                                        {
                                                                                ...
                                                                                ++_i33)
                                                                            {
                                                                                ...
                                                                                _key34 = new Insanity();
                                                                                await
                                                                                    _key34.ReadAsync(iprot,
                                                                                        cancellationToken);
                                                                                _val35 =
                                                                                    await
                                                                                        iprot.ReadStringAsync(
                                                                                            cancellationToken);
                                                                                _elem31[_key34] = _val35;
                                                                            }
                                                                            await
                                                                                iprot.ReadMapEndAsync(cancellationToken);
                                                                        }
                                                                        _elem28.Add(_elem31);
                                                                    }
        ...
        public async Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                await oprot.WriteFieldBeginAsync(field, cancellationToken);
                {
                    ...
                    foreach (
                        Dictionary<THashSet<int>, Dictionary<int, THashSet<List<Dictionary<Insanity, string>>>>> _iter37
                        in List_field)
                    {
                        {
                            await
                                oprot.WriteMapBeginAsync(new TMap(TType.Set, TType.Map, _iter37.Count),
                                    cancellationToken);
                            foreach (THashSet<int> _iter38 in _iter37.Keys)
                            {
                                {
                                    await
                                        oprot.WriteSetBeginAsync(new TSet(TType.I32, _iter38.Count), cancellationToken);
                                ...
                                }
                                {
                                    await
                                        oprot.WriteMapBeginAsync(
                                            new TMap(TType.I32, TType.Set, _iter37[_iter38].Count), cancellationToken);
                                    foreach (int _iter40 in _iter37[_iter38].Keys)
                                    {
                                        await oprot.WriteI32Async(_iter40, cancellationToken);
                                        {
                                            await
                                                oprot.WriteSetBeginAsync(
                                                    new TSet(TType.List, _iter37[_iter38][_iter40].Count),
                                                    cancellationToken);
                                            foreach (
                                                List<Dictionary<Insanity, string>> _iter41 in _iter37[_iter38][_iter40])
                                            {
                                                {
                                                    await
                                                        oprot.WriteListBeginAsync(new TList(TType.Map, _iter41.Count),
                                                            cancellationToken);
        ...
        public struct Isset
        {
            [DataMember] public bool string_field;
            [DataMember] public bool set_field;
            [DataMember] public bool binary_field;
        }
