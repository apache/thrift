...
public abstract class TAsyncSSLClient {
  protected final TProtocolFactory ___protocolFactory;
  protected final TNonblockingSSLTransport ___transport;
  protected final TAsyncSSLClientManager ___manager;
  protected TAsyncSSLMethodCall ___currentMethod;
  private Exception ___error;
  private long ___timeout;

  public TAsyncSSLClient(TProtocolFactory protocolFactory, TAsyncSSLClientManager clientManager, TNonblockingSSLTransport transport) {
    this(protocolFactory, clientManager, transport, 0);
  }

  public TAsyncSSLClient(TProtocolFactory protocolFactory, TAsyncSSLClientManager manager, TNonblockingSSLTransport transport, long timeout) {
