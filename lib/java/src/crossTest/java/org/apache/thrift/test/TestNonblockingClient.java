...
public class TestNonblockingClient extends TestClient {
  ...
  public static void main(String[] args) {
    ...
    ThriftTest.AsyncClient testClient =
        getClient(host, port, socketTimeout, ssl, tProtocolFactory, clientManager);
    ...
    for (int test = 0; test < numTests; ++test) {
      try {
        ...
        latch.await(1, TimeUnit.SECONDS);
        testClient = getClient(host, port, socketTimeout, ssl, tProtocolFactory, clientManager);
  ...
  private static ThriftTest.AsyncClient getClient(
    ...
    return new ThriftTest.AsyncClient(tProtocolFactory, clientManager, transport);
  }
