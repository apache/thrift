...
SInt32 VERSION_1 = 0x80010000;
SInt32 VERSION_MASK = 0xffff0000;
...
-(id) initWithTransport:(id <TTransport>)aTransport
             strictRead:(BOOL)aStrictRead
            strictWrite:(BOOL)aStrictWrite
{
  self = [super init];
  if (self) {
    transport = aTransport;
    strictRead = aStrictRead;
    strictWrite = aStrictWrite;
  }
  return self;
}
