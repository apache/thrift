    ...
    shell: {
      ...
      ThriftGen: {
        command: [
          ...
          '"../../compiler/cpp/thrift" -gen js --out test/gen-js ../../lib/js/test/JsDeepConstructorTest.thrift',
      ...
      ThriftGenDeepConstructor: {
        command: '../../compiler/cpp/thrift -gen js -o test ../../lib/js/test/JsDeepConstructorTest.thrift'
      },
