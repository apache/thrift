...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    shell: {
      InstallThriftJS: {
        command:
          "mkdir test/build; mkdir test/build/js; mkdir test/build/js/lib; cp src/thrift.js test/build/js/thrift.js"
      },
      ...
      ThriftGen: {
        command:
          "../../compiler/cpp/thrift -gen js -gen js:node -o test ../../test/ThriftTest.thrift"
      },
      ThriftGenJQ: {
        command:
          "../../compiler/cpp/thrift -gen js:jquery -gen js:node -o test ../../test/ThriftTest.thrift"
      },
      ...
      ThriftGenES6: {
        command:
          "../../compiler/cpp/thrift -gen js -gen js:es6 -o test ../../test/ThriftTest.thrift"
      },
      ThriftTestServer: {
        options: {
          async: true,
    ...
    qunit: {
      ThriftJS: {
        options: {
          urls: ["http://localhost:8088/test-nojq.html"]
        }
      },
      ThriftJSJQ: {
        options: {
          urls: ["http://localhost:8088/test.html"]
        }
      },
      ThriftJS_DoubleRendering: {
        options: {
          "--ignore-ssl-errors": true,
          urls: ["http://localhost:8088/test-double-rendering.html"]
        }
      },
      ThriftWS: {
        options: {
          urls: ["http://localhost:8088/testws.html"]
        }
      },
      ThriftJS_TLS: {
        options: {
          "--ignore-ssl-errors": true,
          urls: ["https://localhost:8089/test-nojq.html"]
        }
      },
      ThriftJSJQ_TLS: {
        options: {
          "--ignore-ssl-errors": true,
          urls: ["https://localhost:8089/test.html"]
        }
      },
      ThriftWS_TLS: {
        options: {
          "--ignore-ssl-errors": true,
          urls: ["https://localhost:8089/testws.html"]
        }
      },
      ThriftDeepConstructor: {
        options: {
          urls: ["http://localhost:8088/test-deep-constructor.html"]
        }
      },
      ThriftWSES6: {
        options: {
  ...
  grunt.registerTask(
    "wait",
    "Wait just one second for server to start",
    function() {
      var done = this.async();
      setTimeout(function() {
        done(true);
