...
func genBasicFoo() *equalstest.BasicEqualsFoo {
	return &equalstest.BasicEqualsFoo{
		...
		OptEnumFoo:   &(&struct{ x equalstest.EnumFoo }{equalstest.EnumFoo_e1}).x,
		MyByteFoo:    equalstest.Mybyte(8),
		OptMyByteFoo: &(&struct{ x equalstest.Mybyte }{8}).x,
		MyStrFoo:     equalstest.Mystr("9"),
		OptMyStrFoo:  &(&struct{ x equalstest.Mystr }{"9"}).x,
		MyBinFoo:     equalstest.Mybin("10"),
		OptMyBinFoo:  &(&struct{ x equalstest.Mybin }{equalstest.Mybin("10")}).x,
	}
}
...
func genListFoo() *equalstest.ListEqualsFoo {
	return &equalstest.ListEqualsFoo{
		...
		StructListFoo:          []*equalstest.BasicEqualsFoo{genBasicFoo(), &equalstest.BasicEqualsFoo{}},
		OptStructListFoo:       []*equalstest.BasicEqualsFoo{genBasicFoo(), &equalstest.BasicEqualsFoo{}},
		...
		I64StringMapListFoo:    []map[int64]string{map[int64]string{6: "6"}, map[int64]string{5: "5"}, map[int64]string{4: "4"}, map[int64]string{3: "3"}, map[int64]string{2: "2"}, map[int64]string{1: "1"}},
		OptI64StringMapListFoo: []map[int64]string{map[int64]string{6: "6"}, map[int64]string{5: "5"}, map[int64]string{4: "4"}, map[int64]string{3: "3"}, map[int64]string{2: "2"}, map[int64]string{1: "1"}},
...
func genSetFoo() *equalstest.SetEqualsFoo {
	return &equalstest.SetEqualsFoo{
		...
		StructSetFoo:          []*equalstest.BasicEqualsFoo{genBasicFoo(), &equalstest.BasicEqualsFoo{}},
		OptStructSetFoo:       []*equalstest.BasicEqualsFoo{genBasicFoo(), &equalstest.BasicEqualsFoo{}},
		...
		I64StringMapSetFoo:    []map[int64]string{map[int64]string{6: "6"}, map[int64]string{5: "5"}, map[int64]string{4: "4"}, map[int64]string{3: "3"}, map[int64]string{2: "2"}, map[int64]string{1: "1"}},
		OptI64StringMapSetFoo: []map[int64]string{map[int64]string{6: "6"}, map[int64]string{5: "5"}, map[int64]string{4: "4"}, map[int64]string{3: "3"}, map[int64]string{2: "2"}, map[int64]string{1: "1"}},
...
func genMapFoo() *equalstest.MapEqualsFoo {
	return &equalstest.MapEqualsFoo{
		...
		BinStructMapFoo:          map[string]*equalstest.BasicEqualsFoo{"1": genBasicFoo(), "0": &equalstest.BasicEqualsFoo{}},
		OptBinStructMapFoo:       map[string]*equalstest.BasicEqualsFoo{"1": genBasicFoo(), "0": &equalstest.BasicEqualsFoo{}},
