...
bool t_netstd_generator::is_nullable_enabled() const { return nullable_; }

bool t_netstd_generator::is_hashcode_enabled() const { return hashcode_; }
