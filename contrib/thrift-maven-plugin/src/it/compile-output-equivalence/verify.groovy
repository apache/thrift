...
final File outputRoot = new File(basedir, 'target/generated-sources/thrift')
assert outputRoot.isDirectory()

final Map<String, String> expected = loadChecksums(new File(basedir, 'expected-java.sha256'))
final Map<String, String> actual = computeChecksums(outputRoot)

assert expected == actual : "Generated thrift output did not match baseline checksums."
