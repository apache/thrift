 ...
 * 
 * the TestMacro.handle() function implemented below is called for each one of them. 
 * Use thrift --help to get more info about other available options for the Haxe target.
 */
class TestMacro
{
