...
(deftest void-test ()
  (is (null (thrift.test:test-void thrift-cross::*prot*))))
...
(deftest integer-test ()
  (is (= (thrift.test:test-byte thrift-cross::*prot* 127) 127))
  (is (= (thrift.test:test-byte thrift-cross::*prot* -128) -128))
  (is (= (thrift.test:test-byte thrift-cross::*prot* 42) 42))
  (is (= (thrift.test:test-byte thrift-cross::*prot* 0) 0))
  (is (= (thrift.test:test-i32 thrift-cross::*prot* 0) 0))
  (is (= (thrift.test:test-i32 thrift-cross::*prot* 2147483647) 2147483647))
  (is (= (thrift.test:test-i32 thrift-cross::*prot* -2147483648) -2147483648))
  (is (= (thrift.test:test-i64 thrift-cross::*prot* 0) 0))
  (is (= (thrift.test:test-i64 thrift-cross::*prot* 9223372036854775807) 9223372036854775807))
  (is (= (thrift.test:test-i64 thrift-cross::*prot* -9223372036854775808) -9223372036854775808)))

(deftest double-test ()
  (is (= (thrift.test:test-double thrift-cross::*prot* 0.0) 0))
  (is (= (thrift.test:test-double thrift-cross::*prot* 42.0) 42))
  (is (= (thrift.test:test-double thrift-cross::*prot* -555.0) -555))
  (is (= (thrift.test:test-double thrift-cross::*prot* -52.3678) -52.3678)))

(deftest string-test ()
  (is (string= (thrift.test:test-string thrift-cross::*prot* "") ""))
  (is (string= (thrift.test:test-string thrift-cross::*prot* "(defun botsbuildbots () (botsbuilsbots))")
	       "(defun botsbuildbots () (botsbuilsbots))"))
  (is (string= (thrift.test:test-string thrift-cross::*prot* *lang-string*) *lang-string*))
  (is (string= (thrift.test:test-string thrift-cross::*prot* *trick-string*) *trick-string*)))

(deftest binary-test ()
  (is (equalp (thrift.test:test-binary thrift-cross::*prot* #()) #()))
  (is (equalp (thrift.test:test-binary thrift-cross::*prot* *binary-sequence*) *binary-sequence*)))

(deftest enum-test ()
  (is (= (thrift.test:test-enum thrift-cross::*prot* thrift.test:numberz.five) thrift.test:numberz.five))
  (is (= (thrift.test:test-enum thrift-cross::*prot* thrift.test:numberz.eight) thrift.test:numberz.eight))
  (is (= (thrift.test:test-enum thrift-cross::*prot* thrift.test:numberz.one) thrift.test:numberz.one)))

(deftest typedef-test ()
  (is (= (thrift.test:test-typedef thrift-cross::*prot* 309858235082523) 309858235082523)))
